    ...
    "columnDefs": [
        ...
        },
        {
            ...
            "createdCell": function (td, cellData, rowData, row, col) {
                if (cellData !== '') {
                    var images = '';
                    if (rowData['thumb_level'] || rowData['art_level'] || rowData['logo_level'] || rowData['squareArt_level']) {
                        images = ' + images';
                    }
        ...
        },
        {
            ...
            "createdCell": function (td, cellData, rowData, row, col) {
                if (cellData === 1 && rowData['exists']) {
                    var tooltip_title = '';
                    var icon = '';
                    if (rowData['thumb_level'] || rowData['art_level'] || rowData['logo_level'] || rowData['squareArt_level'] || rowData['individual_files']) {
                    ...
                    var icon = (rowData['thumb_level'] || rowData['art_level'] || rowData['logo_level'] || rowData['squareArt_level'] || rowData['individual_files']) ? 'fa-file-archive' : 'fa-file-download';
